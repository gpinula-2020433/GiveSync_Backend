...
import { addPublicationValidation, updatePublicationValidation } from "../../middlewares/validators.js";
...
api.put('/update/:id',[validateJwt, isOwnerOfPublication, updatePublicationValidation], updatePublicaton)
